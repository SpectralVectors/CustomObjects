...
# if 0, show the Basic Panel items
        if bpy.types.Scene.PanelSelect == 0:
            ...
            column.operator("blui.add_uv_sphere",
                            text="Sphere", icon='MESH_UVSPHERE')
            column.operator("blui.add_cylinder",
...
# or else, if it's 1, show the Lights Panel
            ...
            column = split.column(align=True)
            column.operator("blui.add_directional_light",
                            text="Directional", icon='LIGHT_AREA')
            column.operator("blui.add_point_light",
                            text="Point", icon='LIGHT_POINT')
            column.operator("blui.add_spot_light",
                            text="Spot", icon='LIGHT_SPOT')
...
# or else, if it's 2, show the Cinematic Panel
            ...
            column = split.column(align=True)
            column.operator("blui.add_long_camera",
                            text="Camera", icon='VIEW_CAMERA')
# or else, if it's 3, show the Visual Effects Panel
        elif bpy.types.Scene.PanelSelect == 3:
            column = split.column(align=True)
            column.operator("blui.add_cubemap", text="Cubemap",
                            icon='LIGHTPROBE_CUBEMAP')
            column.operator("blui.add_planar", text="Planar",
                            icon='LIGHTPROBE_PLANAR')
            column.operator("blui.add_grid", text="Irradiance",
...
# or else, if it's 4, show the Geometry Panel
            ...
            column.operator("blui.add_cube", text="Cube", icon='MESH_CUBE')
            column.operator("blui.add_circle", text="Circle",
                            icon='MESH_CIRCLE')
            column.operator("blui.add_uv_sphere",
                            text="UV Sphere", icon='MESH_UVSPHERE')
            column.operator("blui.add_ico_sphere",
...
# or else, if it's 5, show the Extras Panel
            ...
            column.operator("blui.add_mirror_sphere",
                            text="Mirror Sphere", icon='MESH_UVSPHERE')
...
class BLUI_MT_unreal_basic_menu(bpy.types.Menu):
    ...
    def draw(self, context):
        ...
        layout.operator("blui.add_cube", text="Cube", icon='MESH_CUBE')
        layout.operator("blui.add_uv_sphere",
                        text="Sphere", icon='MESH_UVSPHERE')
        layout.operator("blui.add_cylinder", text="Cylinder",
                        icon='MESH_CYLINDER')
...
class BLUI_MT_unreal_lights_menu(bpy.types.Menu):
    ...
    def draw(self, context):
        layout = self.layout
        layout.operator("blui.add_directional_light",
                        text="Directional", icon='LIGHT_AREA')
        layout.operator("blui.add_point_light",
                        text="Point", icon='LIGHT_POINT')
...
class BLUI_MT_unreal_cinematic_menu(bpy.types.Menu):
    ...
    def draw(self, context):
        layout = self.layout
        layout.operator("blui.add_long_camera",
                        text="Camera", icon='VIEW_CAMERA')
...
class BLUI_MT_unreal_vfx_menu(bpy.types.Menu):
    ...
    def draw(self, context):
        layout = self.layout
        layout.operator("blui.add_cubemap", text="Cubemap",
                        icon='LIGHTPROBE_CUBEMAP')
        layout.operator("blui.add_planar", text="Planar",
                        icon='LIGHTPROBE_PLANAR')
        layout.operator("blui.add_grid", text="Irradiance",
                        icon='LIGHTPROBE_GRID')
...
class BLUI_MT_unreal_geometry_menu(bpy.types.Menu):
    ...
    def draw(self, context):
        ...
        layout.operator("blui.add_uv_sphere",
                        text="UV Sphere", icon='MESH_UVSPHERE')
        layout.operator("blui.add_ico_sphere",
                        text="Ico Sphere", icon='MESH_ICOSPHERE')
        layout.operator("blui.add_cylinder", text="Cylinder",
                        icon='MESH_CYLINDER')
